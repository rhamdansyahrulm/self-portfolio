...
const PortfolioContent = ({title, tools, image}) => {
  return (
    <div className='flex flex-col text-center justify-center'>
        ...
        <p className='text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, velit debitis earum beatae cum iusto dignissimos eum laboriosam fugiat ullam quas itaque quisquam ab. Atque, quo. Reprehenderit esse distinctio dignissimos!
        </p>
    </div>
  )
}
